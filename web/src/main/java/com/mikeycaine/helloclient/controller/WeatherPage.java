...
import com.mikeycaine.helloclient.service.WeatherBeanLocal;
...
public class WeatherPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<head>");
            out.println("<title>Whether the Weather...</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet WeatherPage at " + request.getContextPath () + "</h1>");
            out.println("<p>" + weatherBean.getWxInfo() + "</p>");
            out.println("</body>");
            out.println("</html>");
